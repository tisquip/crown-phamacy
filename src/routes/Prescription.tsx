      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Send us your valid prescription and our pharmacist will review it
            and provide you with a quote. We deliver across Zimbabwe!
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <ul className="list-disc list-inside space-y-1 text-amber-700">
                  <li>
                    <strong>
                      This service is NOT for emergencies or urgent medical
                      needs.
                    </strong>{" "}
                    If you require urgent assistance, please contact emergency
                    services or visit your nearest hospital immediately.
                  </li>
                  <li>
                    Prescriptions are reviewed during business hours only.
                    Please allow up to 2 hours for a response.
                  </li>
                  <li>
                    A prescription may be <strong>rejected or cancelled</strong>{" "}
                    if it is expired, illegible, incomplete, or does not meet
                    legal requirements.
                  </li>
                  <li>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <section className="border border-border rounded-lg p-4 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                prescription. Submissions missing any of these may be rejected.
              </p>
              <ul className="space-y-1.5 text-sm">
                {[
                  ...
                  { icon: PenLine, text: "Doctor\u2019s original signature" },
                  { icon: Stamp, text: "Doctor\u2019s official stamp / seal" },
                ].map(({ icon: Icon, text }) => (
                  <li
                    key={text}
            ...
            <p className="text-xs text-center text-muted-foreground">
              By submitting you confirm this is a valid, unaltered prescription
